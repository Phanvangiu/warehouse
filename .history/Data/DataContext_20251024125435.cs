    ...
    option.Property(e => e.UpdatedAt).HasDefaultValueSql("GETDATE()");
      ...
      modelBuilder.Entity<StoreStock>(option =>
     {
      ...
      modelBuilder.Entity<User>().HasData(
          new User { Id = 1, Name = "System Admin", Email = "admin@warehouse.com", Password = "123456" },
          new User { Id = 2, Name = "John Employee", Email = "employee@warehouse.com", Password = "123456" },
          new User { Id = 3, Name = "Jane Customer", Email = "customer@warehouse.com", Password = "123456" }
      );
