    ...
    option.Property(e => e.UpdatedAt).HasDefaultValueSql("GETDATE()");
      ...
      modelBuilder.Entity<StoreStock>(option =>
     {
      ...
      modelBuilder.Entity<User>().HasData(
          new User { Id = 1, Name = "System Admin", Email = "admin@warehouse.com", Password = "$2a$11$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36/FHZ0cH0YkL/.oxlWZ92a", RoleId = 1 },
          new User { Id = 2, Name = "John Employee", Email = "employee@warehouse.com", Password = "$2a$11$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36/FHZ0cH0YkL/.oxlWZ92a", RoleId = 2 },
          new User { Id = 3, Name = "Jane Customer", Email = "customer@warehouse.com", Password = "$2a$11$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36/FHZ0cH0YkL/.oxlWZ92a", RoleId = 3 }
      );
