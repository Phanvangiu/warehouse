...
namespace warehouse.Services
{
  public class MyMailService : IMailService
  {
    ...
    private readonly ILogger<MyMailService> _logger;

    public MyMailService(IOptions<MailSetting> mailSetting, IConfiguration configuration, ILogger<MyMailService> logger)
    {
